        ...
        <section id="faq" className="relative z-10 py-8 md:py-12 px-6 max-w-5xl mx-auto text-right">
            ...
            <div className="space-y-4">
                {[
                    ...
                    { q: "3. מהם זמני ועלויות המשלוח?", a: "משלוח חינם בהזמנות מעל ₪200. זמן אספקה: 5–12 ימי עסקים. ייתכנו עיכובים חריגים עקב מצב ביטחוני או תנאי מזג אוויר חריגים, אנו פועלים עם חברת משלוחים מהירה ועושים כל מאמץ לספק את ההזמנה בזמן הקצר ביותר." },
